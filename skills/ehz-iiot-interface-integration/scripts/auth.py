...
ACCOUNT_ID = os.environ.get("ACCOUNT_ID", "admin")
...
class EhzAuthProvider(AuthProvider):
    ...
    def __init__(self):
        self.skill_name: str = "ehz-iiot-interface-integration"  # 外部可注入，如 DynamicApiClient 会覆盖
    ...
    def ensure_token(self) -> tuple[str, str]:
        ...
        if not self._secret_id or not self._secret_key:
            raise RuntimeError(
                ...
                "示例: export SECRET_ID=hziot && export SECRET_KEY=f06a7558-2559-11ee-977a-502b73a03d28"
            )
